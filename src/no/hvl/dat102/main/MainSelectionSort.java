...
public static void main(String[] args) {
		...
		for (int i = 0; i < antal; i++){
			Selectionsort.selectionSort(a[i]); // a[i] blir ein eindimensjonal tabell
		}
		...
		start = System.currentTimeMillis();// start tidsmåling
		for (int i = 0; i < antal; i++){
			Selectionsort.selectionSort(b[i]); // b[i] blir ein eindimensjonal tabell
		}
		slutt = System.currentTimeMillis();// slutt tidsmåling
		...
		start = System.currentTimeMillis();// start tidsmåling
		for (int i = 0; i < antal; i++){
			Selectionsort.selectionSort(c[i]); // c[i] blir ein eindimensjonal tabell
		}
		slutt = System.currentTimeMillis();// slutt tidsmåling
